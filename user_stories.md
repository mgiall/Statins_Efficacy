...
## Anika's Users
**1. Sarah:** <br> 
${{\color{Goldenrod}{\textsf{Who:}}}}$ Sarah is a grad student studying the relationship between gut microbiome and drug responses.<br> ${{\color{OliveDrab}{\textsf{Wants:}}}}$ She wants to analyze how different dietary patterns affect statin efficacy by correlating metagenomic data with blood biomarkers like HMG-CoA and HbA1c levels.<br> ${{\color{CornflowerBlue}{\textsf{Needs:}}}}$ She needs the tool to handle multiple data types and generate publication-ready visualizations without requiring extensive coding.<br> ${{\color{MediumPurple}{\textsf{Skill:}}}}$ Sarah has strong statistical knowledge but limited programming experience.

**2. Dr. Rodriguez:** <br>
${{\color{Goldenrod}{\textsf{Who:}}}}$ Dr. Rodriguez is a clinical researcher working with statin patients <br> ${{\color{OliveDrab}{\textsf{Wants:}}}}$ He wants to identify which foods his patients should eat or avoid to optimize their statin treatment outcomes.<br> ${{\color{CornflowerBlue}{\textsf{Needs:}}}}$ He needs clear, actionable dietary recommendations based on patient-specific microbiome profiles and statin responses.<br> ${{\color{MediumPurple}{\textsf{Skill:}}}}$ He has basic computer skills and no programming experience.
...
**5. Dr. Beck:** <br>
${{\color{Goldenrod}{\textsf{Who:}}}}$ Dr. Chen is the instructor of the course ChemE 546 and in charge of grading this team’s work.<br> ${{\color{OliveDrab}{\textsf{Wants:}}}}$ He wants to track project progress and identify promising patterns in the diet-microbiome-statin interactions.<br> ${{\color{CornflowerBlue}{\textsf{Needs:}}}}$ He needs high-level summaries and the ability to see everyone’s commit history.<br> ${{\color{MediumPurple}{\textsf{Skill:}}}}$ She has good technical skills and extensive software development knowledge.
